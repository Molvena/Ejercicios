...
const scrapping = async (keyWord) => {
  ...
  //Hacemos preguntas para que el usuario decida 
  //lo que quiere scrappear
  //entonces tenemos que clickar el input
  //dandole el tipo con la palabra keyWord
  //tenemos que hacer que se pulse el enter
  ...
  //Le damos el nombre al archivo que se crea dinamico
  // para que coincida con la busqueda
